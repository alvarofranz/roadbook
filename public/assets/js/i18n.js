...
(function () {
    ...
    const T = {
        en: {
            ...
            'help.defRadius': 'A validation radius applied only to notes where you have not set one. Left empty, each waypoint falls back to its type default (WPN/WPC/WPS 90 m · WPM/WPE/WPV 200 m · WPP 30 m), then the 50 m system default.',
