...
(function () {
    ...
    const T = {
        ...
        es: {
            ...
            'Route tools': 'Herramientas de ruta',
            'Standard GPX editing: <b>Reverse</b> the direction of travel, <b>Simplify</b> away GPS noise, <b>Trim</b> to a segment, or <b>Splice</b> another track in. Km, bearings and CAP are recomputed automatically — and every change can be undone.': 'Edición GPX estándar: <b>Invierte</b> el sentido de la marcha, <b>Simplifica</b> el ruido GPS, <b>Recorta</b> a un tramo o <b>Empalma</b> otro track. Km, rumbos y CAP se recalculan solos — y todo cambio se puede deshacer.',
            'Reverse': 'Invertir', 'Flip the direction of travel': 'Invertir el sentido de la marcha',
            'Simplify': 'Simplificar', 'Remove noise points': 'Quitar puntos de ruido',
            'Trim': 'Recortar', 'keep from': 'conservar de', 'to': 'a', 'Trim ends': 'Recortar extremos',
            'Trim the route?': '¿Recortar la ruta?', 'Everything outside the selected notes is deleted.': 'Todo lo que queda fuera de las notas elegidas se borra.',
            'Route reversed — review the vignettes.': 'Ruta invertida — revisa las viñetas.', 'Route trimmed · metrics recomputed.': 'Ruta recortada · métricas recalculadas.',
        ...
        it: {
            ...
            'Route tools': 'Strumenti percorso',
            'Standard GPX editing: <b>Reverse</b> the direction of travel, <b>Simplify</b> away GPS noise, <b>Trim</b> to a segment, or <b>Splice</b> another track in. Km, bearings and CAP are recomputed automatically — and every change can be undone.': 'Editing GPX standard: <b>Inverti</b> il senso di marcia, <b>Semplifica</b> il rumore GPS, <b>Ritaglia</b> un tratto o <b>Innesta</b> un’altra traccia. Km, rotte e CAP si ricalcolano da soli — e ogni modifica si può annullare.',
            'Reverse': 'Inverti', 'Flip the direction of travel': 'Inverti il senso di marcia',
            'Simplify': 'Semplifica', 'Remove noise points': 'Rimuovi punti di rumore',
            'Trim': 'Ritaglia', 'keep from': 'tieni da', 'to': 'a', 'Trim ends': 'Taglia le estremità',
            'Trim the route?': 'Ritagliare il percorso?', 'Everything outside the selected notes is deleted.': 'Tutto ciò che resta fuori dalle note scelte viene eliminato.',
            'Route reversed — review the vignettes.': 'Percorso invertito — controlla le vignette.', 'Route trimmed · metrics recomputed.': 'Percorso ritagliato · metriche ricalcolate.',
