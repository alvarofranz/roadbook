...
(function () {
    ...
    const T = {
        en: {
            ...
            'Shown on the public challenge page': 'Shown on the public roadbook page',
            "Optional. Free text shown on the public challenge page.": "Optional. Free text shown on the public roadbook page.",
            ...
            'Challenge not found.': 'Roadbook not found.',
            'This challenge does not exist or is private.': 'This roadbook does not exist or is private.',
            'Could not load challenge.': 'Could not load roadbook.',
            'Sign in to <b>create, edit and store</b> your roadbooks, share them as <b>public challenges</b>, fork others’ and build your profile — free.': 'Sign in to <b>create, edit and store</b> your roadbooks, share them as <b>public roadbooks</b>, fork others’ and build your profile — free.',
            ...
            'No join code yet — generate one below.': 'No join code yet — generate one below.', 'No join code in this mode.': 'No join code in this mode.',
            'A join code needs the Invite code mode. Switch registration to Invite code?': 'A join code needs the Invite code mode. Switch registration to Invite code?', 'Switch to Invite code': 'Switch to Invite code',
