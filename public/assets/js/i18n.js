...
(function () {
    ...
    const T = {
        en: {
            "land.breadcrumb": "Breadcrumb",
            "land.faq": "Before you set off",
            "land.more": "More ways to adventure",
            "land.tools": "The tools behind the adventure",
            "land.offroad.link": "Explore 4×4 & overlanding",
            "land.moto.link": "Explore moto & enduro",
            "land.bike.link": "Explore bike & MTB",
            "land.offline.q": "Can I follow a roadbook without mobile data?",
            "land.offline.a": "Open your roadbook before setting off. A .rdbk file contains its track, notes and symbols, and GPS positioning does not require mobile data. Online maps, downloading shared roadbooks and syncing your account still need a connection.",
            "land.browser.q": "Browser or native app: which should I use?",
            "land.browser.a": "Use the web Editor on a large screen to prepare your route. On the trail, the iOS and Android apps add background GPS, so a recording can continue with the screen locked. Use the same .rdbk roadbook across devices.",
            "land.offroad.seo.title": "4×4 & Overland Roadbooks — Plan and Navigate | RDBK.app",
            "land.offroad.seo.desc": "Create digital roadbooks for 4×4 trips and overland expeditions. Import GPX, add junction notes, record reconnaissance and navigate with GPS. Free on RDBK.app.",
            "land.offroad.title": "Digital roadbooks for 4×4 & overlanding.",
            "land.offroad.lead": "Turn an expedition track into clear junctions, distances and landmarks. Prepare at home, record your reconnaissance and bring a shared route to the whole convoy.",
            "land.offroad.intro.title": "A clear route for the whole convoy.",
            "land.offroad.intro": "A GPX tells you where the track goes. A roadbook adds what matters at each junction: the exit to take, the distance since the last note and a landmark to recognise. RDBK brings that co-driver’s view to your 4×4 route, from a weekend club outing to a multi-day overland journey.",
            "land.offroad.editor": "Import a GPX or draw the route on the map. Add tulip junction diagrams, landmarks and CAP headings where they help, then keep the finished roadbook as a self-contained .rdbk file.",
            "land.offroad.recorder": "Scout the route with GPS recording. Mark junctions, take geotagged photos and capture voice notes so you can refine the instructions back at your desk.",
            "land.offroad.reader": "Follow each note with total and partial distance, GPS position and heading. The co-driver sees the next instruction clearly; a printable PDF is also available from the roadbook preview.",
            "land.offroad.q": "Can I prepare a roadbook for a 4×4 club outing?",
            "land.offroad.a": "Yes. Build and review the route in the Editor, then publish a public roadbook or attach it to an event. Event tools let organisers manage participants and the roadbooks they will follow. Each crew navigates the prepared instructions in the Reader.",
            "land.moto.seo.title": "Moto & Enduro Roadbooks — Create and Ride | RDBK.app",
            "land.moto.seo.desc": "Prepare roadbooks for enduro, adventure bikes and rally navigation practice. Record GPS tracks, design tulip notes and follow distances and CAP with RDBK.app.",
            "land.moto.title": "Roadbooks for moto, enduro & the next trail.",
            "land.moto.lead": "Ride the route you prepared. Capture a reconnaissance, turn junctions into tulip notes and practise reading distances and CAP headings on your next outing.",
            "land.moto.intro.title": "Learn to read the terrain, one note at a time.",
            "land.moto.intro": "A roadbook makes each junction part of the ride. Instead of only watching a line on the map, you work with a distance, a tulip diagram and a direction. Use RDBK to prepare an enduro loop, document an adventure-bike trip or build a route for rally navigation practice. Start with familiar tracks and add the details that make each turn recognisable.",
            "land.moto.editor": "Build from a GPX and design each junction on a large screen. Add rally symbols, CAP headings and waypoint types, then refine the notes after your reconnaissance.",
            "land.moto.recorder": "Record the trail with GPS and mark points with the Note button. Photos and voice notes capture details for later editing; the native app keeps recording with the screen locked.",
            "land.moto.reader": "Follow the active tulip with partial and total distance, a CAP direction bar and GPS waypoint validation. Configure a compatible handlebar remote to move between notes.",
            "land.moto.q": "Can I use a handlebar remote?",
            "land.moto.a": "RDBK supports keyboard-style remote inputs with configurable controls. Pair your compatible Bluetooth controller with the device, configure its buttons in your profile and check them before riding. The Reader uses that mapping while navigating. Compatibility depends on the signals your controller sends.",
            "land.bike.seo.title": "Bike & MTB Roadbooks — Plan Your Next Ride | RDBK.app",
            "land.bike.seo.desc": "Create roadbooks for mountain biking, gravel routes and club rides. Import GPX tracks, mark trail junctions and share clear navigation notes with RDBK.app.",
            "land.bike.title": "Roadbooks for bike, MTB & gravel adventures.",
            "land.bike.lead": "Give your next ride a little more direction. Turn a GPX into clear trail notes, capture paths worth sharing and bring the whole group along.",
            "land.bike.intro.title": "Every fork in the trail, made clear.",
            "land.bike.intro": "Forest trails and gravel roads often look alike on a map. A roadbook adds the small details: the fork beside a gate, a landmark before a climb or the distance to the next junction. Prepare a mountain-bike loop, a gravel day out or an orientation ride for your club, with notes that help riders recognise the route on the ground.",
            "land.bike.editor": "Import your GPX and turn trail junctions into simple diagrams. Add landmarks and short instructions, review the distances and export a .rdbk roadbook or printable PDF.",
            "land.bike.recorder": "Found a new trail? Record its GPS track and mark useful points along the way. Add photos or voice notes, then use the recording as the starting point for your next roadbook.",
            "land.bike.reader": "Open the prepared roadbook and follow its notes with GPS position and distance. Use the map to see your place on the route and check the next junction before continuing.",
            "land.bike.q": "How can I share a route with my cycling club?",
            "land.bike.a": "Save the roadbook to your account and publish it in the public gallery, or share its exported .rdbk file with the group. Riders can open it in RDBK on their own devices. For an organised outing, event tools bring participants and roadbooks together.",
            "web.eyebrow": "Digital roadbooks. Real adventures.",
            "web.title": "The route is yours.<br><span>Go explore.</span>",
            "web.create": "Create a roadbook",
            "web.explore": "Explore roadbooks",
            "web.promise": "Free. Open source. Ready in your browser.",
            "web.choose": "Choose your adventure",
            "web.moto": "Moto",
            "web.bike": "Bike",
            "web.discover": "Find your adventure",
            "web.strip.route": "From the first waypoint to the finish line",
            "web.strip.open": "Built on the open .rdbk format",
            "web.adventures.kicker": "One passion. Every terrain.",
            "web.adventures.title": "Take the trail your way.",
            "web.adventures.lead": "Four wheels or two. A day out or a whole expedition. Make every turn part of the adventure.",
            "web.offroad.title": "4×4 & Overland",
            "web.offroad.kicker": "Beyond the asphalt",
            "web.offroad.desc": "Plan the expedition. Find your own way through.",
            "web.moto.kicker": "Follow your instinct",
            "web.moto.title": "Moto & Enduro",
            "web.moto.desc": "Capture the trail. Turn a great ride into a roadbook.",
            "web.bike.kicker": "Every climb. Every turn.",
            "web.bike.title": "Bike & MTB",
            "web.bike.desc": "Build your next escape, one waypoint at a time.",
            "web.reader.link": "Discover the Reader",
            "web.recorder.link": "Discover the Recorder",
            "web.editor.link": "Discover the Editor",
            "web.tools.kicker": "From idea to adventure",
            "web.tools.title": "Your whole journey. One toolkit.",
            "web.field.kicker": "Made for the way out",
            "web.field.title": "Plan on the big screen. Take it to the trail.",
            "web.field.lead": "Create in your browser, then bring your roadbooks along on iOS or Android. The same adventure, wherever you are.",
            ...
            'help.radius': 'Validation radius in metres — the geofence for automatic pass detection. Left empty it falls back to the roadbook default, then the type default (WPN/WPC/WPS 90 m · WPM/WPE/WPV 200 m · WPP 30 m), then the 30 m system default. The placeholder shows the fallback in force.',
            ...
            'tour.next': 'Next', 'apk.download': 'Download APK', 'apk.noRelease': 'No direct APK published yet — check back after the next release, or install from the Play Store.',
            ...
            'Add': 'Add', 'Add participant': 'Add participant', 'Search users…': 'Search users…', 'added.': 'added.', 'Activate': 'Activate',
            ...
            'web.gps.warn': 'Browser GPS is unreliable on phones — navigate with the RDBK app.',
