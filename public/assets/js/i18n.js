...
(function () {
    ...
    const T = {
        en: {
            ...
            'Move': 'Move', 'Add note': 'Add note', 'Draw route': 'Draw route', 'Cut': 'Cut', 'Shortcuts': 'Shortcuts',
            ...
            'Move (drag points) — M': 'Move (drag points) — M', 'Draw route — D': 'Draw route — D', 'Cut (tap two points) — C': 'Cut (tap two points) — C',
            ...
            'Grants': 'Grants', 'Admin': 'Admin', 'Organizer': 'Organizer', 'Basic user': 'Basic user', 'With roadbooks': 'With roadbooks', 'Event organizers': 'Event organizers', 'My activity': 'My activity',
