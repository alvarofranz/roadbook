...
(function () {
    ...
    const T = {
        en: {
            'gallery.title': 'Public Challenges', 'gallery.loading': 'Loading challenges…', 'gallery.empty': 'No public challenges yet.',
        },
        es: {
            'gallery.title': 'Challenges públicos', 'gallery.loading': 'Cargando challenges…', 'gallery.empty': 'Aún no hay challenges públicos.',
            'Record a GPS track': 'Graba una traza GPS', 'Build a roadbook': 'Crea un roadbook', 'Navigate a roadbook': 'Navega un roadbook', 'GPS trip computer': 'Ordenador de viaje GPS', 'Build result rankings': 'Genera clasificaciones',
        ...
        it: {
            'gallery.title': 'Challenge pubblici', 'gallery.loading': 'Caricamento challenge…', 'gallery.empty': 'Ancora nessun challenge pubblico.',
            'Record a GPS track': 'Registra una traccia GPS', 'Build a roadbook': 'Crea un roadbook', 'Navigate a roadbook': 'Naviga un roadbook', 'GPS trip computer': 'Computer di viaggio GPS', 'Build result rankings': 'Genera classifiche',
            // ---- tools (the English string is the key) ----
