...
Object.assign(window.RBi18nLangs.it, {
    ...
    'notes.icons': 'Simboli posizionati — vedi <a href="#icons">simboli</a>.',
    'notes.junctions': 'Vettori di incrocio — vedi <a href="#junctions">incroci</a>.',
    'notes.note_kind': 'Opzionale. Dice che cosa la riga È. Assente (o <code>"note"</code>) = una nota di navigazione normale. Qualsiasi altro valore è una <b>riga informativa</b>: mantiene il suo posto nell’elenco ed è mostrata nel Reader, nel PDF e nella vista pubblica, ma non viene mai numerata, posizionata sulla mappa, valutata, convalidata dal GPS né esportata come waypoint GPX/KMZ. Questa versione definisce <code>"photo"</code> (un’immagine con didascalia) e <code>"ad"</code> (il logo di un inserzionista con didascalia); <code>"comment"</code> è il vecchio nome di un annuncio. Una riga informativa convertita da una nota PUÒ conservare i campi waypoint di quella nota: un reader DEVE ignorarli.',
    'notes.image': 'Opzionale (note di commento). Un’immagine incorporata come URI <code>data:</code>, disegnata nel riquadro della nota.',
    'notes.info.intro': 'Una <b>riga informativa</b> porta la sua didascalia in <code>text</code> e la sua immagine come <code>image</code> incorporata:',
    ...
    'conformance.info': 'Un reader conforme DEVE mostrare come riga informativa ogni nota il cui <code>note_kind</code> è presente e diverso da <code>"note"</code>: compare nell’elenco del roadbook, ma non va mai numerata, posizionata sulla mappa, valutata né esportata come waypoint GPX/KMZ.',
    'Full minimal example': 'Esempio minimo completo',
    'Open a .rdbk in the Reader': 'Apri un .rdbk nel Reader',
});
