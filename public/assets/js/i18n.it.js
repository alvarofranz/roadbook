...
(window.RBi18nLangs = window.RBi18nLangs || {}).it = {
            ...
            'feat.2.t': 'Roadbook Recorder', 'feat.2.d': 'Registra un Roadbook con waypoint, note vocali, foto e geotag.',
            ...
            'Waypoint dropped': 'Waypoint aggiunto', 'Uploading photo…': 'Caricamento foto…',
            ...
            'WP type': 'Tipo WP', 'Radius m': 'Raggio m', 'Roadbook type': 'Tipo di roadbook', 'Basic (adventure)': 'Base (avventura)', 'Rally (FIA)': 'Rally (FIA)', 'Waypoint icons': 'Icone waypoint', 'Default WP radius (m)': 'Raggio WP predefinito (m)', 
...
Object.assign(window.RBi18nLangs.it, {
    ...
    'What’s new': 'Novità',
    'about.news.text': 'Ogni versione recente e cosa è cambiato, dalla più nuova alla più vecchia. RDBK.app si aggiorna da sola: il sito e la PWA installata si ricaricano da soli e le app pubblicano la stessa versione sui rispettivi store.',
