...
(window.RBi18nLangs = window.RBi18nLangs || {}).it = {
            ...
            'Unsaved draft': 'Bozza non salvata', 'Recording in progress': 'Registrazione in corso', 'Tripmaster run': 'Percorso Tripmaster', 'Run in progress': 'Percorso in corso', 'Radius m': 'Raggio m', 'Roadbook type': 'Tipo di roadbook', 'Basic (adventure)': 'Base (avventura)', 'Rally (FIA)': 'Rally (FIA)', 'Default WP radius (m)': 'Raggio WP predefinito (m)', 
            ...
            'Auto validation on': 'Validazione auto attivata', 'Auto validation off': 'Validazione auto disattivata',
