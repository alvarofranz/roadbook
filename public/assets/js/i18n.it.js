...
Object.assign(window.RBi18nLangs.it, {
    ...
    'roadtypes.tulip': "La vignetta di una nota è un tulip: la strada da cui arrivi entra dritta dal bordo inferiore fino al centro del riquadro (disegnata secondo <code>road_type_in</code>), la strada da cui esci parte dal centro con una freccia, alla svolta reale (secondo <code>road_type_out</code>), e i <a href=\"#junctions\">vettori di incrocio</a> partono dal centro. Dove la strada curva davvero subito dopo la nota, l’uscita ne segue la forma — una curva, una S — ricavata da <code>track</code> al momento del disegno, mai salvata. Lo spessore del tratto è indicativo del tipo di strada.",
