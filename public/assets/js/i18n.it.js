...
(window.RBi18nLangs = window.RBi18nLangs || {}).it = {
            ...
            'Ready and visible in the event gallery': 'Pronto e visibile nella galleria eventi', 'Public': 'Pubblico', 'Visibility': 'Visibilità', 'Draft': 'Bozza', 'Ready': 'Pronto', 'Status': 'Stato', 'Status updated.': 'Stato aggiornato.',
            ...
            'How will you use it?': 'Come lo userai?',
            ...
            'Paused': 'In pausa', 'End navigation? Your progress on the notes will be lost.': 'Terminare la navigazione? Perderai i progressi sulle note.',
...
'No join code yet — generate one below.': 'Ancora nessun codice: generane uno sotto.', 'No join code in this mode.': 'Nessun codice in questa modalità.',
'A join code needs the Invite code mode. Switch registration to Invite code?': 'Un codice richiede la modalità con invito. Passare a Solo con invito?', 'Switch to Invite code': 'Passa a invito',
...
'Could not join.': 'Impossibile partecipare.',
            ...
            'Could not activate.': 'Impossibile attivare.', 'Link for participants': 'Link per i partecipanti', 'Manage participants': 'Gestione partecipanti',
