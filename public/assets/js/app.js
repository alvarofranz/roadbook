...
(function () {
    ...
    function renderChrome() {
        ...
        header.innerHTML = `<div class="wrap">
            ...
            <nav class="topnav" id="topnav">${navLinks}<div class="lang lang-top" role="group" aria-label="Language" data-i18n-aria="Language"><button data-lang="en">EN</button><button data-lang="es">ES</button><button data-lang="it">IT</button><button data-lang="de">DE</button><button data-lang="fr">FR</button></div></nav>
        </div>`;
        ...
        footer.innerHTML = `<div class="wrap">
            ...
            <div class="lang" role="group" aria-label="Language" data-i18n-aria="Language"><button data-lang="en">EN</button><button data-lang="es">ES</button><button data-lang="it">IT</button><button data-lang="de">DE</button><button data-lang="fr">FR</button></div>
        </div>`;
