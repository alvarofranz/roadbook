...
Die App funktioniert **offline** für Aufzeichnung, Bearbeitung und Navigation. Eine Verbindung wird nur benötigt für: Login, Speichern im Profil, Upload von Fotos, öffentliche Seiten.
...
|------|--------------|---------------|
| **Roadbook Recorder** | Zeichnet eine live GPS-Spur auf und lässt sich mit Waypoints an den Stellen anreichern, die du als Notizen festlegen möchtest; zudem lassen sich Fotos der Kreuzung verknüpfen, damit du dir merkst, wie die Tulpe gezeichnet werden soll oder sonstige Hinweise | Während der Erkundung / der Feldbesichtigung |
| **Editor** | Erstellt oder bearbeitet ein roadbook aus einer Aufzeichnung, aus einem GPX oder aus einem roadbook im openrally-Format; optimiert die Spur, sieht sich die Fotos der Erkundung an, vervollständigt die Notizen und Tulpen durch Zeichnen; die Verwaltung der Pfeile und CAP erfolgt automatisch auf Basis der zugrunde liegenden Spur. Am Ende kannst du es in das Format RDBK, openrally und PDF exportieren, falls du es drucken möchtest | Nach der Aufzeichnung (oder von Null) zum Vorbereiten des endgültigen roadbook |
| **Roadbook Reader** | Ermöglicht die Navigation digitaler roadbook im touristischen oder Wettbewerbsmodus, kann erreichte Notizen automatisch markieren und bietet zusätzlich eine (optionale) Karte, die die Position der einzelnen Notiz relativ zum Fahrzeug zeigt | Während des Events / der Ausfahrt — ist der „Beifahrer" |
| **Tripmaster** | GPS-Bordcomputer ohne roadbook: Gesamt-/Teilodometer, Geschwindigkeit, heading, Stoppuhr, Waypoint-Zähler, GPX-Aufzeichnung | Freie Erkundungen, Tests, Ausfahrten ohne vorgegebenes roadbook |
...
> **Anmeldung mit Google / Apple**: wenn du den Button „Mit Google fortfahren" oder „Mit Apple fortfahren" siehst, kannst du ihn nutzen, um ohne Passwort zu erstellen/anzumelden. Bei Apple kannst du deine E-Mail-Adresse verbergen (E-Mail-Adresse verbergen).
...
| **Fotos & Sprachnotizen** | Eine Sprachnotiz gehört zu ihrer Notiz und reist deshalb immer im `.rdbk` mit. Fotos landen nur im `.rdbk`, wenn du beim Export den Haken „Fotos in die .rdbk aufnehmen" setzt. Sie liegen auf dem Server (Login nötig). Ohne Login bleiben sie auf dem Gerät und kommen in das lokale `.rdbk` |
